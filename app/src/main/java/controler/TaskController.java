...
public class TaskController {
    ...
    public void update(Task task) {
        ...
        try {
           ...
           throw new RuntimeException("Erro ao atualizar a terefa " , ex); 
    ...
    public void removeById(int taskId) {
        ...
        try {
            ...
            throw new RuntimeException("Erro ao deletar a terefa " + ex.getMessage());
        } finally {
            ConnectionFactory.closeConnection(connection, statement);
        }
       ...
       List<Task> tasks = new ArrayList<Task>();
        ...
        try {
            ...
            while(resultSet.next()){
             ...
             throw new RuntimeException("Erro ao inserir a terefa " + ex.getMessage());
        }finally{
